...
let int_in_range ~min ~max = State.int_in_range random_key ~min ~max
let full_int bound = State.full_int random_key bound
let int32 bound = State.int32 random_key bound
let int32_in_range ~min ~max = State.int32_in_range random_key ~min ~max
let nativeint bound = State.nativeint random_key bound
let nativeint_in_range ~min ~max = State.nativeint_in_range random_key ~min ~max
let int64 bound = State.int64 random_key bound
let int64_in_range ~min ~max = State.int64_in_range random_key ~min ~max
